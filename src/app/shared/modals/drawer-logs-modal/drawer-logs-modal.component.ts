...
@Component({
  selector: 'app-drawer-logs-modal',
  templateUrl: './drawer-logs-modal.component.html',
  styleUrls: ['./drawer-logs-modal.component.scss']
})
export class DrawerLogsModalComponent implements OnInit {
